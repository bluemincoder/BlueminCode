            ...
            <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                    ...
                    {hasContent && (
                        <button
                            onClick={handleCopy}
                            className="flex items-center px-4 py-2.5 text-xs text-gray-400 hover:text-gray-300 bg-[#1e1e2e] 
            rounded-xl ring-1 ring-gray-800/50 hover:ring-gray-700/50 transition-all"
                        >
                            {isCopied ? (
                                <>
