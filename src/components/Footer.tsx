    ...
    return (
        <footer className="relative mt-auto w-full bg-transparent">
            <div className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 text-sm text-zinc-400 dark:text-zinc-400">
                    {/* Left: Branding */}
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-center md:text-left text-xs sm:text-sm">
                            Built for Developers, by bluemincoder
                        </span>
                    </div>
