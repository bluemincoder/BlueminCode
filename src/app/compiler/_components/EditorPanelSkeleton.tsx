                ...
                <div className="relative rounded-xl overflow-hidden ring-1 ring-white/[0.05]">
                    ...
                    <div className="h-[600px] bg-[#1e1e2e]/50 backdrop-blur-sm p-4">
                        ...
                        {[...Array(15)].map((_, i) => (
                            ...
                            >
                                <div
                                    className={`w-12 h-4 bg-white/5 rounded`}
                                />
                                <div
...
export function OutputPanelSkeleton() {
    return (
        <div className="relative bg-[#181825]/40 rounded-xl p-4 ring-1 ring-gray-800/50">
            {/* Header */}
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                    <div className="flex items-center justify-center w-6 h-6 rounded-lg bg-[#1e1e2e]/50 ring-1 ring-gray-800/50">
            ...
            <div className="relative">
                ...
                <div className="relative bg-[#1e1e2e]/50 backdrop-blur-sm border border-[#313244]/60 rounded-xl p-4 h-[600px]">
                    <div className="flex items-center justify-center h-full">
                        <div className="text-center">
                            ...
                            />
                            <div
                                className={`w-48 h-4 mx-auto bg-white/5 rounded`}
                            />
                        </div>
                    </div>
                </div>
