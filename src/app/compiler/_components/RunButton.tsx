...
function RunButton() {
    ...
    return (
        <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className={`
        group relative inline-flex items-center gap-2 sm:gap-2.5 px-4 sm:px-5 py-2 sm:py-2.5
                ...
                {isRunning ? (
                    <>
                        <div className="relative">
                            <Loader2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 animate-spin text-white/70" />
                    ...
                    <>
                        <div className="relative flex items-center justify-center w-3.5 h-3.5 sm:w-4 sm:h-4">
                            <Play className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white/90 transition-transform group-hover:scale-110 group-hover:text-white" />
                        </div>
